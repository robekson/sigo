...
public class NormasResource {
    ...
    public NormasResource(NormasService normasService) {
     ...
     */
    @GetMapping("/normas")
    public List<NormasDTO> getAllNormas() {
        log.debug("REST request to get all Normas");
        return normasService.findAll();
    }
