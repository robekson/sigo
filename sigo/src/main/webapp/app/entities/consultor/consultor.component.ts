...
export class ConsultorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.consultorService
      ...
      .subscribe(
        (res: HttpResponse<IConsultor[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInConsultors(): void {
    this.eventSubscriber = this.eventManager.subscribe('consultorListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IConsultor[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
